...
const ChatMessages = ({ receiver }: { receiver: userWithActivities }) => {
    ...
    return (
        <div className='h-[calc(100vh-500)] flex flex-col bg-zinc-900'>
            {/* Header */}
            ...
            <div className='p-4 border-t border-zinc-700 bg-zinc-800/30 backdrop-blur-sm'>
                <div className='flex gap-3 items-end'>
                    <div className='flex-1 relative'>
                        <Input
                            placeholder={`Message ${receiver.firstName || 'user'}...`}
                            value={newMessage}
